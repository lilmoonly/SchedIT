    ...
    public partial class AddGroupToSchedule : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleRatings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScheduleRatings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScheduleRatings_Schedules_ScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleRatings_ScheduleId",
                table: "ScheduleRatings",
                column: "ScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduleRatings_UserId",
                table: "ScheduleRatings",
                column: "UserId");
